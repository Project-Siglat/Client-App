<div class="min-h-screen bg-gradient-to-br from-black via-gray-900 to-black text-white">
    ...
    <div class="container mx-auto">
      ...
      <div class="grid md:grid-cols-3 gap-8">
        <div class="text-center p-8 bg-gradient-to-b from-gray-800/50 to-black/50 rounded-2xl border border-yellow-400/20 hover:border-yellow-400/40 transition-all duration-300 backdrop-blur-sm">
          ...
          <h4 class="text-xl font-semibold mb-4 text-white">Rapid Response</h4>
          <p class="text-gray-300 leading-relaxed">Lightning-fast emergency response to save lives and protect property in critical situations.</p>
        </div>
        <div class="text-center p-8 bg-gradient-to-b from-gray-800/50 to-black/50 rounded-2xl border border-red-400/20 hover:border-red-400/40 transition-all duration-300 backdrop-blur-sm">
          ...
          <h4 class="text-xl font-semibold mb-4 text-white">Professional Rescue</h4>
          <p class="text-gray-300 leading-relaxed">Trained emergency professionals equipped to handle any crisis in Villaverde, Nueva Vizcaya.</p>
        </div>
        <div class="text-center p-8 bg-gradient-to-b from-gray-800/50 to-black/50 rounded-2xl border border-yellow-400/20 hover:border-yellow-400/40 transition-all duration-300 backdrop-blur-sm">
          <div class="text-yellow-400 text-5xl mb-6">🕐</div>
          <h4 class="text-xl font-semibold mb-4 text-white">24/7 Availability</h4>
          <p class="text-gray-300 leading-relaxed">Round-the-clock emergency services - we're always ready to respond when you need us most.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <!-- CTA Section -->
  <section class="py-20 px-6 bg-gradient-to-r from-red-950/30 via-red-900/40 to-red-950/30">
    <div class="container mx-auto text-center">
      ...
      <button class="bg-gradient-to-r from-black via-gray-900 to-black hover:from-gray-900 hover:to-black text-yellow-400 font-semibold py-4 px-10 rounded-xl transition-all duration-300 border border-yellow-400/30 hover:border-yellow-400/60 shadow-lg">
  ...
  <!-- Footer -->
  <footer class="bg-gradient-to-r from-black via-gray-900 to-black py-12 px-6 border-t border-gray-700">
    <div class="container mx-auto text-center">
        <p class="text-gray-400">&copy; 2025 SIGLAT Emergency Services. All rights reserved.</p>
    </div>
  </footer>
</div>
